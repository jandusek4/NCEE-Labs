...
![IBM Cloud Resources](images/ibm_cloud_resources.png)
![IBM Cloud Resource List](images/ibm_cloud_resources_list.png)
...
5. Choose **New knowledge**.
   
   <img width="1000" alt="image" src="hands-on-lab-assets/step_6_1_v3.png">
...
8. Copy the following name into the **Name** field

   ```
   Employee Benefits
   ```

9. Copy the following description into the **Description** section and then click on **Save**:
...
15. Turn on the toggle button for **Chat with documents**. Select **None** in **Citations show in chat**. Turn on the toggle button for **Show agent**. Click on **Deploy** in the top right corner to deploy your agent. On the next screen click on **Deploy** button. After the validation and deployment is done, you will be asked to activate agent monitoring, choose **Maybe later**
